...
try {
  ...
  await Promise.all([
    appendDailyMemoryEntry("2026-09-03", "聊天摘要", "session-2\0turn-1", "### 第一条", { configDir: root }),
    appendDailyMemoryEntry("2026-09-03", "聊天摘要", "session-3\0turn-1", "### 第二条", { configDir: root })
  ]);
